...
export function DepartmentBanner({
  ...
  accent,
  image,
  imageAlt = "Albirri Hospital department banner",
  breadcrumb,
  ...
  return (
    <section className="relative isolate flex min-h-72 items-center justify-center overflow-hidden px-4 py-16 sm:min-h-80 sm:px-6 lg:px-8">
      ...
      {/* Overlays to match the health checkup design */}
      <div className="absolute inset-0 -z-20 bg-[#0b245f]/80" />
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-[#071a47]/95 via-[#12368f]/75 to-[#10b981]/30" />
      ...
      >
        ...
        >
          {t(titleStart)}
          {accent && <span className="text-emerald-300"> {t(accent)}</span>}
        </motion.h1>
