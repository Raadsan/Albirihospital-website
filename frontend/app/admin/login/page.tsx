...
export default function AdminLoginPage() {
  return (
    <main className="grid min-h-svh flex-1 bg-muted/30 lg:grid-cols-2">
      <section className="relative hidden overflow-hidden bg-[#1E40AF] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(195,240,219,0.38),transparent_42%)]" />
        ...
        <div className="relative max-w-lg space-y-5">
          <div className="flex size-12 items-center justify-center rounded-2xl bg-[#C3F0DB]/20 ring-1 ring-[#C3F0DB]/35">
